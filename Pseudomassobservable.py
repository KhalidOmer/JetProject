...
###############################################################################
#the function normv retruns the axis of the rotation; the vector u and the 
#function input"vector" form a plane, from which find a vector which is 
...
#informaton of the particle(the for momentum, the initial position and the 
#final position) and d is a flat list of l.
#first the particle is being rotated with angle theta "rot1" 
#then is rotated by angle phi rot2
...
#################
plt.hist(m, bins=30, alpha=0.5, label='R=1',color='blue')
plt.hist(k, bins=30, alpha=0.5, label='R=.05',color='red')
plt.hist(n, bins=30, alpha=0.5, label ='R=.01',color='yellow')
